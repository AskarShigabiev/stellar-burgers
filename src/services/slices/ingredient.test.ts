...
import IngredientSliceReducer from '../slices/ingredient';

describe('тест ингредиенты', () => {
  const ingredientState = {
    ingredients: [],
    isLoading: false
  };

  test('закгрузка ингредииентов', () => {
    ...
    const state = IngredientSliceReducer(ingredientState, action);
    const { ingredients, isLoading } = state;
    expect(ingredients).toEqual(ingredientsLoaded);
